<script setup>
const data = ref([
  { kode: 'Achmad Febry', nama: '1-1-2001' },
  { kode: 'Achmad Febry', nama: '1-1-2001' },
  { kode: 'Achmad Febry', nama: '1-1-2001' },
  { kode: 'Achmad Febry', nama: '1-1-2001' },
  { kode: 'Achmad Febry', nama: '1-1-2001' },
...
<template>
  <div class="p-4">
    <div class="flex items-center justify-between mb-4">
      ...
      <NuxtLink to="/absensi/create" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
        + Tambah Absensi
      </NuxtLink>
    </div>
    ...
    <div class="mb-4 flex items-center">
      ...
      <div class="ml-auto">
        ...
        <input
          type="text"
          id="search"
          placeholder="Search by nama Absensi"
